...
import { getAuthorByUserId } from "./authorService.js";
...
const comments = [
    ...
    { 
        ...
        isLiked: false,
        isDisliked: false,
        message: 'Por fin ha llegado. Ahora si le dedicare todo el tiempo necesario.', 
    ...
    { 
        ...
        isLiked: false,
        isDisliked: false,
        message: 'He visto muchas reseñas sobre este juego, pero ahora estoy decidido a comprarlo', 
...
export const saveComment = async (commentDto) => {
    ...
    commentDto.author = await getAuthorByUserId(commentDto.userId);
    
    delete commentDto.userId;
