import { includeSpace, isEmptyOrNull, isLengthInRangeMax, isLengthInRangeMin, isRegex, isString } from "../validationsUtils.js";

export const validateEmail = (email) => {

    const regex = /\S+@\S+\.\S+/;
    const fieldName = 'El correo';
    const result = isEmptyOrNull(email, fieldName);
...
export const validatePassword = (password) => {
    ...
    const result = isEmptyOrNull(password, fieldName);
